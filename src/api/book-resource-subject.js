...
// 添加编辑资源列表
export function addOrUpdateBookResourceType(params) {
    return api.post('tool_book_resource/addOrUpdateBookResourceType', params)
}

// 添加编辑资源列表
export function deleteBookResourceType(params) {
    return api.post('tool_book_resource/deleteBookResourceType', params)
}
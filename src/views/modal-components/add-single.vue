<template>
  <Modal class="common-dialog" title="创建单选题" v-model="addSingleModal" @on-visible-change="visibleChange" :mask-closable="false">
...
export default {
  ...
  // computed: {
  //   ...mapState({
  //     questionData: state => state.feedback.questionData
  //   })
  // },
  // watch: {
  ...
  methods: {
    ...
    visibleChange(v) {
      if (!v) this.addSingleModal = false;
    },
    addOption() {
